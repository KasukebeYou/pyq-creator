...
(function () {
  ...
  ready(() => {
    ...
    async function showWorldbookConfig() {
        ...
        try {
            // [修改] 修正了动态导入的路径，并清理了导入的变量
            const { loadWorldInfo, world_names, getContext } = await import('../../scripts/world-info.js');
